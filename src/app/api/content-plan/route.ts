...
const SYSTEM_PROMPT = `你是顶级的小红书内容策略专家。为电商卖家生成一周的完整内容排期计划。

你输出的内容要像真实的内容运营团队做出来的方案一样专业、可执行。

每个内容计划包含7天（周一到周日），每天有不同的内容角度和完整的一篇内容。

每一天的内容结构：
- 日期和周次标签（如：周一｜产品种草型）
- 标题
- 正文（小红书风格，带emoji，分段清晰）
- 配图建议（具体描述，用于实际拍摄/AI生成）
- 标签（5-8个）
- 发布时间建议
- 互动引导话术（怎么引导用户评论）
...
一周的内容角度分配策略：
- 周一：产品引入（场景切入，引起共鸣）
- 周二：使用教程/方法（提供价值，收藏型内容）
- 周三：成分/技术解析（专业信任建设）
- 周四：效果展示/对比（视觉冲击，引发欲望）
- 周五：优惠/活动（临门一脚，促进转化）
- 周六：轻松/生活方式（品牌好感度）
- 周日：总结/测评（决策辅助，高转化）
...
export async function POST(request: NextRequest) {
  try {
    const { product, features, targetAudience, competitorContent, platform } = await request.json();
    ...
    const userPrompt = `请为一款产品生成一周（7天）的${platformName}内容排期计划。
...
${competitorContent ? `【竞品参考素材】\n${competitorContent.slice(0, 1000)}` : ""}

要求：
1. 内容要有真实感，不能像广告
2. 每天的内容角度不能重复
3. 符合${platformName}平台的调性
4. 配图建议要具体可执行
5. 标签要有策略（大流量+精准标签组合）
6. 给出最佳发布时间
7. 每篇内容要完整，可以直接使用`;
    ...
    return NextResponse.json({
      ...
      daily_plan: [
        ...
        },
        {
          ...
          angle_reason: "周三中段用户理性思考，成分分析建立专业信任，利于转化决策"
        },
        {
          day: "周四",
          ...
          angle_reason: "周四晚上用户放松刷手机，视觉冲击型内容最容易出爆款"
        },
        {
          day: "周五",
          ...
          body: "蹲了很久的姐妹看过来！\n\nXXX终于有活动了！！\n平时真的很少打折\n这次被我蹲到了！\n\n🎁 福利内容：\n✅ 买一送一！\n✅ 还送小样套装\n✅ 满XX再减XX\n\n🕐 时间：今晚8点-明晚12点\n⏳ 只有100份！卖完就没\n\n我上次原价买的亏大了😭\n这次一定要多囤几份！\n\n想入手的姐妹抓紧\n这种力度一年可能就一次！",
          image_suggestions: "活动海报风格，产品+优惠信息，红色/金色促销色调，「限时」字样醒目",
          hashtags: ["#限时优惠", "#好物推荐", "#剁手清单", "#福利", "#买到赚到"],
          engagement_hook: "你们抢到了吗？评论区告诉我！没抢到的我看看能不能再申请福利！",
          angle_reason: "周五下班后是购物决策高峰期，限时优惠刺激即时下单"
        },
        {
          day: "周六",
          ...
          body: "周六的晚上是我最享受的时光✨\n\n点上香薰蜡烛🕯️\n放上喜欢的音乐🎵\n开始我的晚间护肤仪式🧴\n\nStep 1: 卸妆（要卸干净！）\nStep 2: 温和洁面\nStep 3: 敷个面膜（一周2-3次）\nStep 4: 涂上XXX，按摩吸收\nStep 5: 眼霜+唇膜\n\n做完这些窝在沙发里看剧📺\n真的太治愈了\n\n生活需要这些小小的仪式感\n让自己在忙碌的一周后好好放松\n\n你们周末有什么治愈的小习惯吗？",
          image_suggestions: "温馨的房间氛围，香薰蜡烛+护肤品摆在一起，暖色灯光，生活感强的场景照",
          hashtags: ["#晚间护肤", "#治愈系", "#周末生活", "#精致女孩", "#护肤仪式"],
          engagement_hook: "分享你们的周末治愈小习惯！一人说一个！",
          angle_reason: "周六用户放松状态，生活感内容增加品牌好感度，引发共鸣分享"
        },
        {
          day: "周日",
          ...
          body: "这周发了6篇关于XXX的内容\n后台收到好多姐妹的私信\n问的最多的就是：到底值不值得买？\n\n今天统一回答：值得！但要看适不适合你👇\n\n✅ 适合谁买：\n• 皮肤有闭口、痘印的\n• 想要提亮肤色的\n• 预算不高想找平替的\n• 敏感肌也能用的\n\n❌ 不适合谁买：\n• 追求立竿见影效果的\n• 不喜欢任何质地的\n• 已经找到完美产品的\n\n📝 我的使用总结：\n用了28天，皮肤真的变好了\n性价比很高，会回购\n\n有问题评论区留言\n我一个个回复！",
          image_suggestions: "产品+使用前后对比图汇总，生活感的场景拍摄，暖色调，温馨真实",
          hashtags: ["#好物推荐", "#真实测评", "#种草还是拔草", "#护肤分享", "#值得买"],
          engagement_hook: "还有什么问题在评论区问！能回答的都回答！",
          angle_reason: "周日晚上用户做决策，总结型内容帮助最后转化，评论区互动增加热度"
        }
      ]
    });
  }
